...
# Matetrip Backend API 명세서

## 목차
- [1. Auth (인증)](#1-auth-인증)
- [2. Post Participation (게시글 참여)](#2-post-participation-게시글-참여)
- [3. Binary Content (파일 관리)](#3-binary-content-파일-관리)
- [4. Notifications (알림)](#4-notifications-알림)
- [5. Profile (프로필)](#5-profile-프로필)
- [6. Users (사용자)](#6-users-사용자)
- [7. Post (게시글)](#7-post-게시글)
- [8. Matching (매칭)](#8-matching-매칭)
- [9. Place (장소)](#9-place-장소)
- [10. Review (리뷰)](#10-review-리뷰)
- [11. Workspace (워크스페이스)](#11-workspace-워크스페이스)
